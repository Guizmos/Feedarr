...
public sealed class ReleaseVersionComparerTests
{
    ...
    [InlineData("1.2.3")]
    [InlineData("v1.2.3")]
    [InlineData("feedarr-v1.2.3")]
    [InlineData("1.2.3-beta.1")]
    [InlineData("feedarr-v1.2.3-beta.1")]
    ...
    public void IsUpdateAvailable_Handles_VPrefix_And_Prerelease_Filter()
    {
        ...
        Assert.True(ReleaseVersionComparer.IsUpdateAvailable("1.4.9", "feedarr-v1.5.0", allowPrerelease: false));
